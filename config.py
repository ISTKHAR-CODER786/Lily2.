...
BOT_USERNAME = getenv("BOT_USERNAME" , "MahiMusic_Robot")
BOT_NAME = getenv("BOT_NAME" , "⋆ ᴍᴀʜɪ ✘ ᴍᴜsɪᴄ ⋆,")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/ISTKHAR-CODER786/Lily2.",)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN", None)
PRIVACY_LINK = getenv("PRIVACY_LINK", "https://telegra.ph/Privacy-Policy-for-TEAM-ISTKHAR-08-30")
...
autoclean = []
confirmer = {}
START_IMG_URL = getenv("START_IMG_URL", "https://files.catbox.moe/lbtavd.jpg")
