...
❖ 𝐏ᴏᴡᴇʀᴇᴅ 𝖡ʏ » [❤️‍🔥꯭⃕ ⃪꯭〬𐏓꯭𝐈꯭꯭ѕ꯭꯭፝֠֩‌тк꯭꯭н፝֠֩‌α꯭꯭я꯭꯭𝄄𝄀꯭𝄄꯭🔥꯭᪳](https://t.me/ll_ISTKHAR_BABY_lll)**
'''
...
```
 єxᴧϻᴘʟє : @MahiMusic_Robot @ll_ISTKHAR_BABY_lll I love You 😘
```
...
─────────────────────────
❍ ᴄσηᴛᴧᴄᴛ - [❤️‍🔥꯭⃕ ⃪꯭〬𐏓꯭𝐈꯭꯭ѕ꯭꯭፝֠֩‌тк꯭꯭н፝֠֩‌α꯭꯭я꯭꯭𝄄𝄀꯭𝄄꯭🔥꯭᪳](https://t.me/ll_ISTKHAR_BABY_lll)
─────────────────────────**
'''
    HELP_ABOUT = '''
**─────────────────────────
│ ᴡєʟᴄσϻє ᴛσ ˹[тєᴧϻ ᴛʜᴜɴᴅᴇʀ](https://t.me/THUNDERDEVS)˼ ʙσᴛ sᴛᴧᴛυs │
─────────────────────────
       ❖ │ ʀєᴧʟ ᴛɪϻє ʙσᴛ's sᴛᴧᴛυs │❖
─────────────────────────
╭⎋ [ᴍᴀʜɪ ꭙ ϻυsɪᴄ](https://t.me/@MahiMusic_Robot) : ᴧʟɪᴠє 
╰⊚ υᴘᴛɪϻє : 12ʜ:58ϻ:20s | ᴄᴘυ : 5.0% | 
       υsᴧɢє : 24 | ᴧssɪsᴛᴧηᴛs : 01
       
╭⎋ [ᴛʜᴜɴᴅᴇʀ ꭙ ϻυsɪᴄ](https://t.me/PihuMusicRobot) : ᴧʟɪᴠє 
╰⊚ υᴘᴛɪϻє : 12ʜ:58ϻ:20s | ᴄᴘυ : 5.0% | 
       υsᴧɢє : 24 | ᴧssɪsᴛᴧηᴛs : 01

╭⎋ [𝐒ᴘᴏᴛɪғʏ ꭙ ϻυsɪᴄ](https://t.me/SpootifyMusicbot) : ᴧʟɪᴠє 
╰⊚ υᴘᴛɪϻє : 12ʜ:58ϻ:20s | ᴄᴘυ : 5.0% | 
       υsᴧɢє : 24 | ᴧssɪsᴛᴧηᴛs : 01
─────────────────────────
⊚ ʙσᴛ sᴛᴧᴛυs ᴧηᴅ ϻσʀє ʙσᴛs - [ᴄʟɪᴄᴋ ʜєʀє](https://t.me/THUNDERDEVS/263)
─────────────────────────
⊚ ʟᴧsᴛ ᴄʜєᴄᴋєᴅ ση : ᴅᴧᴛє : 10 ᴊᴀɴ 2025 
─────────────────────────
❍ 𝐏ᴏᴡєʀєᴅ 𝖡ʏ » [❤️‍🔥꯭⃕ ⃪꯭〬𐏓꯭𝐈꯭꯭ѕ꯭꯭፝֠֩‌тк꯭꯭н፝֠֩‌α꯭꯭я꯭꯭𝄄𝄀꯭𝄄꯭🔥꯭᪳](https://t.me/ll_ISTKHAR_BABY_lll)
─────────────────────────**
'''
    HELP_ALLBOT = '''
**─────────────────────────
...
❖ sυᴘᴘσʀᴛ ᴄʜᴧᴛ ➥ [ᴛʜᴜɴᴅᴇʀ-ᴜᴘᴅᴧᴛєs](https://t.me/THUNDERDEVS)
❖ ʙᴏᴛ σᴡηєʀ ➥ [⋆⎯꯭‌𝅃꯭᳚❤️‍🔥꯭⃕ ⃪꯭〬𐏓꯭𝐈꯭꯭ѕ꯭꯭፝֠֩‌тк꯭꯭н፝֠֩‌α꯭꯭я꯭꯭𝄄𝄀꯭𝄄꯭🔥꯭᪳𝆺꯭𝅥⎯‌꯭⟶](https://t.me/ll_ISTKHAR_BABY_lll)
